...
@public_bp.route('/krida1')
@public_bp.route('/krida1.html')
def krida1():
    try:
        return render_template('krida1.html', title='krida1')
    except TemplateNotFound:
        abort(404)

@public_bp.route('/krida2')
@public_bp.route('/krida2.html')
def krida2():
    try:
        return render_template('krida2.html', title='krida2')
    except TemplateNotFound:
        abort(404)

@public_bp.route('/krida3')
@public_bp.route('/krida3.html')
def krida3():
    try:
        return render_template('krida3.html', title='krida3')
    except TemplateNotFound:
        abort(404)

@public_bp.route('/krida4')
@public_bp.route('/krida4.html')
def krida4():
    try:
        return render_template('krida4.html', title='krida4')
    except TemplateNotFound:
        abort(404) 

@public_bp.route('/krida5')
@public_bp.route('/krida5.html')
def krida5():
    try:
        return render_template('krida5.html', title='krida5')
    except TemplateNotFound:
        abort(404)
